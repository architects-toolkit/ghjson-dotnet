...
{
    /// <summary>
    /// Options for getting objects from the Grasshopper canvas.
    /// </summary>
    public sealed class GetOptions
    {
        /// <summary>
        /// Gets the default get options.
        /// </summary>
        public static GetOptions Default { get; } = new GetOptions();

        /// <summary>
        /// Gets or sets a value indicating whether to only get selected objects.
        /// </summary>
