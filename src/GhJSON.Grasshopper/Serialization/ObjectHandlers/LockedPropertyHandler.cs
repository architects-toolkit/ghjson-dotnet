...
{
    /// <summary>
    /// Handler for component locked (disabled) state.
    /// </summary>
    internal sealed class LockedPropertyHandler : IObjectHandler
    {
        /// <inheritdoc/>
        ...
        public void Serialize(IGH_DocumentObject obj, GhJsonComponent component)
        {
            if (obj is IGH_ActiveObject activeObj && activeObj.Locked)
            {
                ...
                component.ComponentState.Locked ??= true;
            }
        }
        ...
        {
            if (component.ComponentState?.Locked == true && obj is IGH_ActiveObject activeObj)
            {
