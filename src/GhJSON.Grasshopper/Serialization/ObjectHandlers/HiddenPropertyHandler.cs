...
{
    /// <summary>
    /// Handler for component hidden (preview disabled) state.
    /// </summary>
    internal sealed class HiddenPropertyHandler : IObjectHandler
    {
        ...
        {
            return obj is IGH_PreviewObject;
        }
        ...
        public void Serialize(IGH_DocumentObject obj, GhJsonComponent component)
        {
            if (obj is IGH_PreviewObject previewObj && previewObj.Hidden)
            {
                ...
                component.ComponentState.Hidden ??= true;
            }
        }
        ...
        {
            if (component.ComponentState?.Hidden == true && obj is IGH_PreviewObject previewObj)
            {
                previewObj.Hidden = true;
            }
        }
    }
}
