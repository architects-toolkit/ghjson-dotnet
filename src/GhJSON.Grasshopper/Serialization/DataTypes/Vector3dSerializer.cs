...
{
    /// <summary>
    /// Serializer for Vector3d values.
    /// Format: vectorXYZ:x,y,z
    /// </summary>
    internal sealed class Vector3dSerializer : IDataTypeSerializer<Vector3d>
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        public string Prefix => "vectorXYZ";

        /// <inheritdoc/>
        public string Serialize(Vector3d value)
        {
        ...
        {
            return this.Serialize((Vector3d)value);
        }

        /// <inheritdoc/>
        public Vector3d Deserialize(string value)
        {
            if (!this.IsValid(value))
            {
                throw new ArgumentException($"Invalid Vector3d format: {value}");
            }
